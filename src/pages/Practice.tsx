...
export default function Practice() {
  const { 
    query, questionCount, subject, examType, questions, loading, selectedOptions, showSolutions,
    setQuery, setQuestionCount, setSubject, setExamType, setSelectedOption, generateQuestions 
  } = usePracticeStore();
...
<body>
    <div class="header">
        ...
        <p>Generated by Sunrise Classroom AI • ${questions.length} Questions • ${subject} • ${examType}</p>
    </div>
    ...
    <script>
      ...
      const contextStr = `title=${query} Practice Set|teacher=${role === 'teacher' ? 'Teacher' : role}|subject=${subject}|class=${examType}|description=Interactive practice questions for ${query} (${questionCount} Qs)|fileType=HTML Quiz`;
      ...
      <div className="glass-panel rounded-2xl p-6 mb-8 border border-white/10 space-y-4">
        ...
        <div className="relative flex items-center">
          ...
          <input 
            ...
            placeholder={`e.g. ${questionCount} pyqs of ${examType} in ${subject}...`}
