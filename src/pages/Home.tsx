...
export default function Home() {
  ...
  return (
    <div className="min-h-screen pb-32">
      <Helmet>
        <title>Home | Smart Sunrise - AI Powered Classroom</title>
        <meta name="description" content="Welcome to Smart Sunrise, the ultimate AI-powered classroom experience. Generate content, practice dynamically, and visualize concepts with ease." />
      </Helmet>
