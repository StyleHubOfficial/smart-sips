...
export default function Home() {
  ...
  return (
    <div className="min-h-screen pb-32">
      ...
      <section className="py-20 px-6 max-w-[1920px] mx-auto 2xl:px-12 relative z-20">
        <motion.div 
        ...
        {/* Key Features */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6 mb-32">
          {[
            ...
            { icon: BookOpen, title: "Classroom Dashboard", desc: "Organized content delivery and management.", color: "from-pink-500 to-rose-500", delay: 0.9, link: "/courses" },
              ...
              <div 
                key={idx} 
                className={`block h-full card-interactive ${navigatingTo === feature.link ? 'mobile-force-active' : ''}`}
              ...
              >
                <motion.div
                  ...
                  transition={{ 
                    duration: 0.6,
                    delay: feature.delay * 0.5, // Faster stagger
                    type: "spring",
                    stiffness: 100
                  }}
                  whileHover={{ 
